...
import { UilCreditCard, UilDialpadAlt, UilEstate } from '@/icons';
        ...
        >
          ...
          >
            ...
            >
              <div
                className={cn(
                  'rounded-3xl sm:w-[52px] sm:h-[52px] w-11 h-11 flex bg-white/20 dark:bg-white/10 justify-center items-center !p-0 pointer-events-none hover:bg-white dark:hover:bg-white/30'
                  // modalOpen === CRYPTO_DEPOSIT_MODAL && "bg-blue-300 "
                )}
              >
                <UilCreditCard
                  className={cn(
                    'w-6 h-6 text-blue-300 opacity-50 dark:text-white'
            ...
            <CustomToolTip content={'Reveal PIN'}>
              <div
                className={cn(
            ...
            <CustomToolTip content={'Limit & Fee'}>
              <div
                className={cn(
                  'rounded-3xl sm:w-[52px] sm:h-[52px] w-11 h-11 bg-white/20 dark:bg-white/10 flex justify-center items-center cursor-pointer !p-0 hover:bg-white dark:hover:bg-white/30'
