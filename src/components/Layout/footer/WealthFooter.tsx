...
import { CRYPTO_DEPOSIT_MODAL, FOOTER_MENU_HUB } from '@/constants';
    ...
    <>
      {!isFooterModal && (
        ...
        >
          ...
          <div
            className={cn(
              'flex justify-center items-center gap-x-2 bg-gray-250/50 dark:bg-gray-250/10 w-[68px] rounded-3xl p-2 backdrop-blur-[10px] h-[68px] mb-5 sm:mb-0',
              modalOpen.length > 0 && 'shadow-lg'
            )}
          >
            <CustomToolTip content={'Primary Market'}>
              <Link href="/wealth/market-place">
                <div
                  className={cn(
                    'rounded-3xl sm:w-[52px] sm:h-[52px] w-11 h-11 flex bg-white/20 dark:bg-white/10 justify-center items-center cursor-pointer !p-0 hover:bg-white dark:hover:bg-white/30',
