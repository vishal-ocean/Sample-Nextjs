          ...
          >
            ...
            <CustomToolTip content={'Swap'}>
              <div
                className={cn(
                  ...
                  SWAP_MODALS.includes(modalOpen) && 'bg-blue-300'
                )}
              ...
              >
                <IconSwap
                  className={cn(
                    ...
                    SWAP_MODALS.includes(modalOpen) && 'text-white'
                  )}
                />
              </div>
            </CustomToolTip>
            <CustomToolTip content={'Withdraw'}>
              <div
                className={cn(
                  'rounded-3xl sm:w-[52px] sm:h-[52px] w-11 h-11 bg-white/20 dark:bg-white/10 flex justify-center items-center cursor-pointer !p-0 hover:bg-white dark:hover:bg-white/30',
                  TRANSFER_MODALS.includes(modalOpen) && 'bg-blue-300'
                )}
              ...
              >
                <IconTimeCoinWithdraw
                  className={cn(
                    'w-6 h-6 text-blue-300 dark:text-white',
                    TRANSFER_MODALS.includes(modalOpen) && 'text-white'
                  )}
                  strokeWidth={1.2}
                />
              </div>
            ...
            <CustomToolTip content={'Deposit'}>
              <div
                className={cn(
                  'rounded-3xl sm:w-[52px] sm:h-[52px] w-11 h-11 bg-white/20 dark:bg-white/10 flex justify-center items-center cursor-pointer !p-0 hover:bg-white dark:hover:bg-white/30',
                  DEPOSIT_MODALS.includes(modalOpen) && 'bg-blue-300'
                )}
                onClick={() => setHandleModal(CRYPTO_DEPOSIT_MODAL)}
              >
                <IconTimeCoinDeposit
                  className={cn(
                    'w-6 h-6 text-blue-300 dark:text-white',
                    DEPOSIT_MODALS.includes(modalOpen) && 'text-white'
                  )}
                  strokeWidth={1.2}
                />
              </div>
