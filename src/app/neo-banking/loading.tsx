...
const Loading = () => {
  return (
    <>
      <div className="grid grid-cols-12 gap-3 mt-5 mx-3 sm:mx-10 lg:mx-4 xl:mx-0">
        <div className="lg:col-span-9 col-span-12 lg:order-1 order-2">
          ...
          <div className="grid grid-cols-6 gap-2 mt-2">
            {[...Array(6)].map((_, index) => (
              <div
                className="p-5 bg-white dark:bg-opacity-10 rounded-[24px] flex justify-center items-center flex-col gap-y-3 animate-pulse sm:col-span-1 col-span-2"
                key={index}
              >
      ...
      <div className="bg-white dark:bg-opacity-10 rounded-[24px] mt-5 pt-8 mx-3 sm:mx-10 lg:mx-4 xl:mx-0">
        <FullTableSkeleton />
      </div>
    </>
  );
