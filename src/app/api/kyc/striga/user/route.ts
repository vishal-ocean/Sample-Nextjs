import { getUserValidationSchema } from "@/backend/Striga/UserValidationSchema";
...
export async function POST(req: NextRequest) {
  try {
    ...
    await getUserValidationSchema(endpoint)?.validate(data);
