...
const ConfirmWithdrawModal = () => {
  ...
  const handleOpenChange = (e: boolean) => {
    setHandleModal(e ? YIELD_CONFIRM_WITHDRAW_MODAL : '');
  };

  return (
    <CustomModal
      open={modalOpen == YIELD_CONFIRM_WITHDRAW_MODAL}
    ...
    >
      <div className="flex justify-between">
        <div className="flex gap-x-2 items-center">
          <Button
            variant="secondary"
            className="py-3 px-4 text-14 font-700 leading-4 dark:text-white dark:bg-white/15"
            onClick={() => {
        ...
        <div className="mt-10">
          <div className="flex justify-between">
            ...
            <span className="flex gap-x-2">
              <RowImageStack ImageData={['BTC', 'USDT']} />
          ...
          <Button
            ...
            type="submit"
            onClick={() => setHandleModal(YIELD_CRYPTO_WITHDRAW_SUCCESS_MODAL)}
          >
            Confirm Withdraw
          </Button>
        </div>
