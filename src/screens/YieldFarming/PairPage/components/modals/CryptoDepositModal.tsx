...
const CryptoDepositModal = () => {
  ...
  const handleOpenChange = (e: boolean) => {
    setHandleModal(e ? YIELD_CRYPTO_DEPOSIT_MODAL : '');
  };
  return (
    <CustomModal
      open={modalOpen == YIELD_CRYPTO_DEPOSIT_MODAL}
    ...
    >
      ...
      <div className="sm:px-7 flex flex-col gap-y-5 mt-6">
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  openAssetsDropDown &&
                    'bg-blue-300 text-white rotate-0 dark:text-blue-300 dark:bg-white'
                )}
              >
        ...
        <div>
          <p className="font-500 leading-4 text-12 text-gray-300 flex gap-x-1 items-center">
            Network
            ...
            >
              <div className="flex gap-x-2 items-center">
                {networkValue ? (
                  ...
                  <div className="w-6 h-6 rounded-3xl bg-secondary dark:bg-white/5" />
                )}
                <span
                  className={cn(
                    'font-700 leading-5 text-16 text-blue-300 dark:text-white',
        ...
        <div>
          <p className="font-500 leading-4 text-12 text-gray-300">Amount</p>
          <div className="flex justify-between ">
            <Input
              type="number"
              id="search-assets"
              className="input w-full leading-5 outline-none placeholder:text-16 placeholder:text-gray-300 placeholder:leading-5  placeholder:font-700 placeholder:font-body  text-16 font-500 font-body cursor-pointer text-blue-300  border-none rounded-[16px] mt-3 sm:mt-3 p-4 bg-gray-100 gap-x-6 dark:bg-white/5 dark:text-white dark:placeholder:text-white/30"
              placeholder="0.00"
              step="any"
            />
          </div>
        ...
        <Button
          ...
          type="submit"
          onClick={() => setHandleModal(YIELD_CONFIRM_DEPOSIT_MODAL)}
        >
          Preview Deposit
        </Button>
      </div>
