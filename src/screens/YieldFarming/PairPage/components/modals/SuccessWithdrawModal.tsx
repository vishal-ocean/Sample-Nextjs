...
import { YIELD_CRYPTO_WITHDRAW_SUCCESS_MODAL } from '@/constants';
...
const SuccessWithdrawModal = () => {
  ...
  const handleOpenChange = (e: boolean) => {
    setHandleModal(e ? YIELD_CRYPTO_WITHDRAW_SUCCESS_MODAL : '');
  ...
  return (
    <CustomModal
      open={modalOpen === YIELD_CRYPTO_WITHDRAW_SUCCESS_MODAL}
