...
const CardsSection = () => {
  return (
    <div className="flex lg:flex-col lg:col-span-4 xl:col-span-3 col-span-12 gap-2 gap-x-2 lg:order-2 order-1 overflow-x-auto lg:overflow-x-hidden px-3 sm:pl-10 md:px-10 lg:px-0 remove-scrollbar">
      ...
      <div className="lg:h-[188px] relative rounded-[24px] min-w-[260px] lg:min-w-0 w-1/3 lg:w-auto">
        <Image
          ...
          sizes="100vh"
          alt=""
          className="w-full h-full hidden lg:block absolute top-0 -z-10 rounded-[24px]"
        />
        <Image
      ...
      <div className="lg:h-[188px] relative rounded-[24px] min-w-[260px] lg:min-w-0 w-1/3 lg:w-auto">
        <Image
          ...
          sizes="100vh"
          alt=""
          className="w-full h-full hidden absolute -z-10 lg:block rounded-[24px]"
        />
        <Image
