...
import { useAssets } from "@/screens/Crypto/Home/components/useAssets";
...
const CryptoAssetList = ({
  ...
  const [tableData, setTableData] = useState<AssetsListingData[]>(assetsData);
  ...
  useEffect(() => {
    if (assetsData) {
      const modifiedData = getModifiedAssetsData(assetsData);
      ...
      {isLoading || isRefetching ? (
        ...
        <>
          <div className="w-full sm:p-6 p-0 mt-2 ">
            <div className="grid grid-cols-[2fr_1.5fr_3fr_4.5fr]">
              {HEADERS.map((item, index) => (
                <div
                  className={cn(
                    "px-[10px] text-12 font-500 text-gray-300 dark:text-white/30 leading-4 min-[980px]:block hidden w-full",
                    index === 0 && "min-w-[172px]"
                  )}
                  key={index}
                >
                ...
                tableData?.map((item: any, index: number) => {
                  return (
                    <React.Fragment key={index}>
                      <div className="py-5 mx-[10px] min-[980px]:hover:mx-0 min-[980px]:hover:px-[10px] min-[980px]:hover:rounded-xl grid grid-cols-12 min-[980px]:grid-cols-[2fr_1.5fr_3fr_3fr_1.5fr] border-b border-b-secondary dark:border-b-white/10 min-[980px]:hover:bg-gray-100 cursor-pointer dark:hover:bg-white dark:hover:bg-opacity-5 gap-y-4 sm:gap-y-5">
                        <div
                        ...
                        >
                          ...
                          <div className="flex flex-col leading-5 ">
                            ...
                            <span className="font-500 text-gray-300 w-20 min-[980px]:w-[120px] sm:w-[120px] truncate  dark:text-white/30">
                              {item?.shortName === "USDT"
                                ? "Tether USD"
                                : item?.shortName === "LTC"
                                ? "Litecoin"
                        ...
                        <div
                          className="grid col-span-7 min-[980px]:grid-cols-1 gap-x-2 items-center min-[980px]:col-span-1 "
                          onClick={() => {
                            if (item?.assetsOnOtherChains?.length > 0) {
                              if (openChainList.includes(item?.id)) {
                                setOpenChainList(
                        ...
                        >
                          <p className="min-[980px]:hidden block text-12 leading-4 text-gray-300  mb-1">
                            chain
                          </p>
                          <div className="grid grid-cols-[auto_1fr] sm:gap-x-2 items-center gap-x-1 min-[980px]:grid-cols-[auto] xl:grid-cols-[auto_1fr]">
                            ...
                            {/* <span className="text-blue-300 dark:text-white font-500 sm:leading-5 sm:text-16 text-12 leading-4 block min-[980px]:hidden xl:block">
                              {item?.assetsOnOtherChains?.length > 0
                        ...
                        <div
                          className="row-start-1 col-start-6 min-[980px]:col-span-1 min-[980px]:col-start-3 col-span-6 px-[10px]"
                          onClick={() => {
                            if (item?.assetsOnOtherChains?.length > 0) {
                              if (openChainList.includes(item?.id)) {
                                setOpenChainList(
                        ...
                        <div
                          className="flex min-[980px]:flex-col flex-col min-[980px]:col-start-4 col-start-9 items-end min-[980px]:col-span-1 col-span-4 min-[980px]:items-baseline px-[10px]"
                          onClick={() => {
                            if (item?.assetsOnOtherChains?.length > 0) {
                              if (openChainList.includes(item?.id)) {
                                setOpenChainList(
                        ...
                        >
                          <p className="text-gray-300 min-[980px]:hidden block text-12 leading-4 whitespace-nowrap mb-1">
                            Market Price
                          </p>
                          <div className="flex min-[980px]:flex-col flex-row gap-x-1">
                        ...
                        <div className="flex sm:justify-end items-center row-start-1 col-start-12 min-[980px]:col-start-5 justify-center">
                          {item?.assetsOnOtherChains?.length > 0 ? (
                            <Button
                              variant="secondary"
                              className={cn(
                      ...
                      <div
                        className={cn(
                          "min-[980px]:pl-[52px] mb-1 min-[980px]:mb-0 pl-0 min-[980px]:pr-[52px] pr-0 bg-gray-100 dark:bg-white/30 sm:dark:bg-transparent sm:bg-white min-[980px]:rounded-b-none rounded-b-xl ",
                          openChainList?.includes(item?.id) &&
                            item?.assetsOnOtherChains?.length > 0 &&
                            "sm:py-0 py-[10px]"
                        )}
                        ...
                        {openChainList?.includes(item?.id) &&
                          item?.assetsOnOtherChains?.map((asset: any) => {
                            return (
                              <div
                                className={cn(
                                  "py-[6px] mx-[10px] hover:mx-0 hover:px-[10px]  hover:rounded-xl sm:py-4 grid sm:grid-cols-[5fr_2fr_5fr] grid-cols-[5fr_4fr_3fr]  sm:border-b sm:border-b-secondary dark:border-b-white/10 min-[980px]:hover:bg-gray-100 cursor-pointer dark:hover:bg-white dark:hover:bg-opacity-5 relative",
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div className="flex flex-col leading-5">
                                    ...
                                    <span className="font-500 text-gray-300 w-20 min-[980px]:w-[120px] sm:w-[120px]  truncate xl:w-auto dark:text-white/30">
                                      {asset?.name}
                                    </span>
                                  </div>
                                </div>
